            ...
            <div class="card-body">
                <form action="{{ route('admin.destinations.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="caption" placeholder="{{ __('caption') }}" name="caption" value="{{ old('caption') }}" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="image">{{ __('image') }} (JPEG, PNG, JPG, GIF, SVG, WEBP, BMP)</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="people" placeholder="{{ __('Number of people') }}" name="people" value="{{ old('people') }}" />
                    </div>
                    <div class="form-group">
