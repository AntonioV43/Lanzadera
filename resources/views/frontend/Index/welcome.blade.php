      ...
      <nav class="fixed top-0 left-0 right-0 z-50 flex flex-col items-center py-4 px-8 font-prompt" style="background-color: rgba(146, 95, 226, 0.07);">
        <div class="flex items-center justify-between w-full max-w-6xl">
            ...
            <ul class="flex space-x-8 text-black font-medium mx-auto">
                ...
                @else
                    <li><a href="{{ route('login') }}" class="hover:underline">Categories</a></li>
                    <li><a href="{{ route('login') }}" class="hover:underline">Favourite</a></li>
                    <li><a href="{{ route('login') }}" class="hover:underline">My Order</a></li>
                @endauth
            </ul>
            ...
            <div class="flex items-center space-x-4 absolute right-8">
                @auth
                <a onclick="return document.getElementById('logout').submit();" href="#" class="px-4 py-2 text-white hover:underline">Logout</a>
                    <a href="/profile" class="w-10 h-10 rounded-full border-2 border-white shadow">
                    <img src="/images/profile.svg" alt="Profile" class="w-full h-full object-cover rounded-full"></a>
                    <form id="logout" action="{{route('logout') }}" method="post">
                  @csrf
                    </form>
                  @else
                <!-- Logout Button -->
                    <a href="{{ route('register') }}" class="px-4 py-2 text-black hover:underline border border-white">Register</a>
...
<div class="relative z-10 flex justify-center px-4">
  <div class="bg-white text-gray-900 p-6 rounded-full flex flex-wrap items-center gap-6 shadow-lg w-full max-w-5xl">
    ...
    <!-- Search Button -->
    @auth
      <a href="/categories" class="ml-auto bg-purple-600 text-white px-6 py-3 rounded-full font-bold hover:bg-purple-700 transition whitespace-nowrap">
        🔍 Explore Now
      </a>
    @else
      <a href="{{ route('login') }}" class="ml-auto bg-purple-600 text-white px-6 py-3 rounded-full font-bold hover:bg-purple-700 transition whitespace-nowrap">
        🔍 Login to Explore
    </a>
    @endauth
  </div>
...
<div class="min-h-screen bg-[#E4D6FF] flex flex-col items-center justify-center space-y-12 py-12 px-4">
  ...
  <div class="w-full max-w-5xl space-y-8">
    ...
    <div class="flex flex-wrap justify-center gap-6">
      @auth
      <a href="/categories" class="bg-white p-8 rounded-xl shadow-lg border-2 border-red-300 hover:scale-105 transition-transform duration-300 text-center w-56 h-56 flex flex-col items-center justify-center">
      ...
      @else
        <a href="{{ route('login') }}" class="bg-white p-8 rounded-xl shadow-lg border-2 border-red-300 hover:scale-105 transition-transform duration-300 text-center w-56 h-56 flex flex-col items-center justify-center">
        <img src="/images/indo.svg" alt="Indonesian Adventures" class="mx-auto w-16 h-16" />
        <p class="mt-4 font-semibold text-lg">Indonesian Adventures</p>
      </a>
      @endauth
...
<div class="relative w-full max-w-5xl">
  ...
  <div class="bg-white p-6 flex flex-col md:flex-row justify-between items-center rounded-b-lg mt-4">
    ...
    @auth
      <a href="/categories" class="bg-purple-600 text-white px-4 py-2 rounded-md hover:bg-purple-700 transition">See More</a>
        @else
          <a href="{{ route('login') }}" class="bg-purple-600 text-white px-4 py-2 rounded-md hover:bg-purple-700 transition">Login to See</a>
    @endauth
  </div>
</div>
  ...
  <div class="max-w-7xl mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-6 h-full">
      ...
      <div class="md:col-span-8 row-span-2 relative rounded-2xl overflow-hidden group">
        <img src="/images/RajaAmpat.png" alt="Raja Ampat" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex flex-col justify-end p-8">
          <h3 class="text-3xl font-bold text-white">Raja Ampat</h3>
          <p class="text-white/90 mt-2">Explore wonders and charming scenery</p>
          @auth
            <a href="/categories" class="mt-4 bg-purple-600 text-white px-6 py-2 rounded-full font-medium hover:bg-purple-700 transition self-start">
                Explore
            </a>
          @else
            <a href="{{ route('login') }}" class="mt-4 bg-purple-600 text-white px-6 py-2 rounded-full font-medium hover:bg-purple-700 transition self-start">
                Login to Explore
            </a>
          @endauth
        </div>
      ...
      <div class="md:col-span-4 relative rounded-2xl overflow-hidden group h-64">
        <img src="/images/karimunjawa.jpg" alt="karimunjawa" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
        <div class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent flex flex-col justify-end p-6">
          <h3 class="text-xl font-bold text-white">Karimunjawa</h3>
      ...
      <!-- Middle Right Card -->
      <div class="md:col-span-4 relative rounded-2xl overflow-hidden group h-64">
        <img src="/images/pulaukomodo.jpg" alt="komodo" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
        <div class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent flex flex-col justify-end p-6">
          <h3 class="text-xl font-bold text-white">Pulau Komodo</h3>
          <p class="text-white/80 text-sm mt-1">Meet "Indonesian Great Dragon"</p>
        </div>
      </div>
      ...
      <div class="md:col-span-4 relative rounded-2xl overflow-hidden group h-64">
        <img src="/images/borobudur.jpg" alt="borobudur" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
        <div class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent flex flex-col justify-end p-6">
          <h3 class="text-xl font-bold text-white">Candi Borobudur</h3>
          <p class="text-white/80 text-sm mt-1">Historical Buddhism Temple</p>
        </div>
      </div>

      <div class="md:col-span-4 relative rounded-2xl overflow-hidden group h-64">
        <img src="/images/dieng.jpg" alt="dieng" class="w-full h-full object-cover transition-transform duration-500 group-hover:scale-105">
        <div class="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent flex flex-col justify-end p-6">
          <h3 class="text-xl font-bold text-white">Dieng</h3>
    ...
    <div class="text-center mt-12">
      @auth
    <a href="/categories" class="bg-white text-purple-600 px-8 py-3 rounded-full font-bold hover:bg-gray-100 transition border-2 border-purple-600">
        View All Destinations
    </a>
@else
    <a href="{{ route('login') }}" class="bg-white text-purple-600 px-8 py-3 rounded-full font-bold hover:bg-gray-100 transition border-2 border-purple-600">
        Login to View
    </a>
@endauth
    </div>
    ...
    <div class="flex justify-center items-stretch gap-8 flex-wrap">
      ...
      <div class="bg-white rounded-2xl w-80 overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col">
        <div class="h-60 overflow-hidden">
          <img src="/images/nusapenida.jpg" alt="indonesia" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500">
        </div>
        <div class="p-6 flex-grow">
          <div class="flex justify-between items-start">
            <h2 class="text-xl font-bold text-gray-800">Nusa Penida, Indonesia</h2>
      ...
      <div class="bg-white rounded-2xl w-88 overflow-hidden shadow-2xl hover:shadow-3xl transition-all duration-300 flex flex-col transform scale-105 z-10">
        ...
        <div class="p-6 flex-grow">
          ...
          <div class="mt-8 pt-5 border-t border-gray-100 flex justify-between items-center">
            ...
            <a href="/booking" class="bg-purple-600 text-white px-6 py-3 rounded-lg font-bold hover:bg-purple-700 transition flex items-center">
      ...
      <div class="bg-white rounded-2xl w-80 overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 flex flex-col">
        <div class="h-60 overflow-hidden">
          <img src="/images/bromo.webp" alt="Bromo" class="w-full h-full object-cover hover:scale-105 transition-transform duration-500">
        </div>
        <div class="p-6 flex-grow">
          <h2 class="text-xl font-bold text-gray-800">Bromo, Indonesia</h2>
          <p class="text-gray-500 mt-2">Luxury mountain with beautiful scenery</p>
