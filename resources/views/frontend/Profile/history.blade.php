...
<head>
  ...
  <title>Riwayat Pesanan - Lanzadera</title>
  <!-- Link Google Fonts -->
...
<section class="col-span-3 bg-white p-6 rounded-lg shadow mt-0">
  ...
  <!-- CARD PESANAN 1 -->
  <div class="flex items-start bg-purple-50 p-4 rounded-xl mb-4 shadow-sm">
    <img src="/images/NusaPenida1.jpeg" alt="Bali Trip" class="w-32 h-32 rounded-lg object-cover mr-4">
    <div class="flex-1">
      <h2 class="text-lg font-semibold">Liburan Seru Bali – Ubud & Nusa Penida</h2>
      <p class="text-sm text-gray-600">Tanggal: <strong>25–30 Nov 2024</strong></p>
      <p class="text-sm text-gray-600">Peserta: <strong>2 Dewasa, 1 Anak</strong></p>
      <p class="text-sm text-gray-600">Total: <strong>Rp15.000.000</strong></p>
      <p class="text-sm text-gray-600 mb-2">Status: <strong>Selesai</strong></p>

      <div class="flex items-center space-x-1 mb-2 rating" data-rating="0">
        <span class="star text-2xl text-gray-400 cursor-pointer" data-index="1">&#9734;</span>
        <span class="star text-2xl text-gray-400 cursor-pointer" data-index="2">&#9734;</span>
        <span class="star text-2xl text-gray-400 cursor-pointer" data-index="3">&#9734;</span>
        <span class="star text-2xl text-gray-400 cursor-pointer" data-index="4">&#9734;</span>
        <span class="star text-2xl text-gray-400 cursor-pointer" data-index="5">&#9734;</span>
      </div>

      <textarea class="w-full p-2 rounded border border-gray-300 text-sm mb-2" rows="3" placeholder="Ulasan"></textarea>
      <button class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-1 rounded text-sm">Send</button>
    </div>
  </div>

  <!-- CARD PESANAN 2 -->
  <div class="flex items-start bg-purple-50 p-4 rounded-xl mb-4 shadow-sm">
    <img src="/images/Wakatobi.jpg" alt="Wakatobi Trip" class="w-32 h-32 rounded-lg object-cover mr-4">
    <div class="flex-1">
      <h2 class="text-lg font-semibold">Menyusuri Keindahan Wakatobi</h2>
      <p class="text-sm text-gray-600">Tanggal: <strong>15–19 Apr 2025</strong></p>
      <p class="text-sm text-gray-600">Peserta: <strong>2 Dewasa</strong></p>
      <p class="text-sm text-gray-600">Total: <strong>Rp12.550.000</strong></p>
      <p class="text-sm text-gray-600 mb-2">Status: <strong>Selesai</strong></p>
