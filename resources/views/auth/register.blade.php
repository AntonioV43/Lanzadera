...
<body class="h-screen m-0 p-0 overflow-hidden relative font-[Poppins]">

  <!-- Background and Decorative Elements -->
  <div class="absolute inset-0 bg-Purple z-0"></div>
  <div class="fixed inset-0 z-0 pointer-events-none" id="purple-shapes">
    <img src="{{ asset('/images/Blob.svg') }}" class="absolute bottom-[10vh] right-[30vw] w-[15vw]" />
    <img src="{{ asset('/images/Blob1.svg') }}" class="absolute top-0 right-[20vw] w-[20vw]" />
    <img src="{{ asset('/images/Blob2.svg') }}" class="absolute top-[15vh] right-0 w-[10vw]" />
    <img src="{{ asset('/images/Blob4.svg') }}" class="absolute bottom-[-35vh] right-[-5vw] w-[60vw]" />
    <img src="{{ asset('/images/Blob5.svg') }}" class="absolute top-0 right-0 w-[20vw]" />
  ...
  <div id="accountCreatedPopup" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
    <div class="bg-white rounded-xl p-8 max-w-md w-full mx-4 popup-animation">
      <div class="text-center">
        ...
        <button onclick="closePopup()" class="w-full bg-Purple text-white py-2 rounded font-semibold hover:bg-opacity-90 transition">Continue to Login</button>
      </div>
    </div>
  </div>
  ...
  <div id="errorPopup" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden">
    <div class="bg-white rounded-xl p-8 max-w-md w-full mx-4 popup-animation">
      <div class="text-center">
        ...
        <button onclick="closeErrorPopup()" class="w-full bg-Purple text-white py-2 rounded font-semibold hover:bg-opacity-90 transition">Try Again</button>
      </div>
    </div>
  </div>
