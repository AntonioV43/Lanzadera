      ...
      <nav class="fixed top-0 left-0 right-0 z-50 flex flex-col items-center py-4 px-8 font-prompt" style="background-color: rgba(146, 95, 226, 1);">
        <div class="flex items-center justify-between w-full max-w-6xl">
            ...
            <ul class="flex space-x-8 text-white font-medium mx-auto">
                ...
                <li><a href="#destination" class="hover:underline">Discover</a></li>
...
<div class="flex items-center space-x-4 absolute right-8">
    @guest
        ...
        <a href="{{ route('register') }}" class="px-4 py-2 bg-white text-purple-600 rounded-md hover:bg-gray-100 transition">Sign Up</a>
    @else
        <!-- Logout Button -->
        <a href="{{ route('logout') }}" 
        ...
        <!-- Profile Picture with User Name - Now clickable -->
        <a href="#" class="flex items-center space-x-2 hover:opacity-80 transition">
            <div class="w-10 h-10 rounded-full border-2 border-white shadow">
...
<div id="destination" class="min-h-screen bg-[#E4D6FF] flex flex-col items-center justify-center space-y-12 py-12 px-4">
